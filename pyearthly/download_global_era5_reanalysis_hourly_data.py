...
def download_global_era5_reanalysis_hourly_data(url, key, product_type, format, variable, year, month, day, time, 
                                                download_folder_path=None, final_destination_path=None, filename=None): 
